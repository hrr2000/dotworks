...
/***/ "./resources/js/user_panel/orders/datatable.js":
/*!*****************************************************!*\
  !*** ./resources/js/user_panel/orders/datatable.js ***!
  \*****************************************************/
...
var UserComingOrdersDataTable = function UserComingOrdersDataTable() {
  ...
  $('#ordersSearch').on('keyup', function (e) {
    dataTable.search(e.target.value);
    dataTable.draw();
  });
};

/* harmony default export */ const __WEBPACK_DEFAULT_EXPORT__ = (UserComingOrdersDataTable);
/**
 *
 * @param url image url
 * @returns {string}
...
function TableImage(url) {
  return "\n        <div style=\"border-radius: 50%; width: 50px; height: 50px; background-image: url(".concat(url, "); background-size: cover; background-position: center\"></div>\n    ");
}
/**
 *
...
function OrderClientAnchor(client) {
  return "<a href=\"".concat(client['profileUrl'], "\" target=\"_blank\">").concat(client['name'], "</a>");
}
/**
 *
...
function OrderServiceAnchor(order) {
  return "<a href=\"".concat(order['serviceUrl'], "\" target=\"_blank\">").concat(order['serviceTitle'], " ").concat(order['packageType'], "</a>");
}
/**
 *
...
function OrderActionButtons(order) {
  return "\n        <a href=\"".concat(order['viewUrl'], "\" class=\"btn btn-light shadow-0 text-dark btn-sm\" >\n            <i class=\"fa fa-eye\"></i>\n        </a>\n    ");
}

/***/ }),

/***/ "./resources/js/user_panel/orders/deliver.js":
/*!***************************************************!*\
  !*** ./resources/js/user_panel/orders/deliver.js ***!
  \***************************************************/
/***/ ((__unused_webpack_module, __webpack_exports__, __webpack_require__) => {
...
var confirmDeliveryBtn = $('#confirmDeliveryButton');
var confirmFilesButton = $('#confirmFilesButton');
var fileUploadBox = $('.file-upload');
var orderFileUploadInput = $('#orderFileUpload');

var UserOrderDeliver = function UserOrderDeliver() {
  chooseUnFinishedStep();
  var deliveryFiles = [];

  if ($('#deliveryUploadForm').length) {
    var dropzone = new dropzone__WEBPACK_IMPORTED_MODULE_0__["default"]('#deliveryUploadForm', {
      addRemoveLinks: true
    });
    ...
    dropzone.on('removedfile', function (file) {
      deliveryFiles = deliveryFiles.filter(function (item) {
  ...
  confirmDeliveryBtn.on('click', function () {
    $.ajax(confirmDeliveryBtn.data('url'), {
      ...
      beforeSend: function beforeSend() {
        return confirmDeliveryBtn.attr('disabled', true);
      },
  ...
  confirmFilesButton.on('click', function () {
    $.ajax(confirmFilesButton.data('url'), {
      ...
      beforeSend: function beforeSend() {
        return confirmFilesButton.attr('disabled', true);
      },
      success: function success(res) {
        addToast('success', 'Success', res.success);
...
/* harmony default export */ const __WEBPACK_DEFAULT_EXPORT__ = (UserOrderDeliver);

function chooseUnFinishedStep() {
  var stepBoxes = $('.step-box');

  var _iterator = _createForOfIteratorHelper(stepBoxes),
      _step;
...
"use strict";
/*!*************************************************!*\
  !*** ./resources/js/user_panel/orders/index.js ***!
  \*************************************************/
__webpack_require__.r(__webpack_exports__);
/* harmony export */ __webpack_require__.d(__webpack_exports__, {
...
/* harmony import */ var _datatable__WEBPACK_IMPORTED_MODULE_1__ = __webpack_require__(/*! ./datatable */ "./resources/js/user_panel/orders/datatable.js");
/* harmony import */ var _deliver__WEBPACK_IMPORTED_MODULE_2__ = __webpack_require__(/*! ./deliver */ "./resources/js/user_panel/orders/deliver.js");
/* harmony import */ var rater_js__WEBPACK_IMPORTED_MODULE_3__ = __webpack_require__(/*! rater-js */ "./node_modules/rater-js/index.js");
/* harmony import */ var rater_js__WEBPACK_IMPORTED_MODULE_3___default = /*#__PURE__*/__webpack_require__.n(rater_js__WEBPACK_IMPORTED_MODULE_3__);
...
function Orders() {
  var timeInSeconds = $('#remainingTimeCounter').data('time'),
      isVisible = false;
  ...
  if (ratingElement) {
    var orderRater = rater_js__WEBPACK_IMPORTED_MODULE_3___default()({
  ...
  var askForFileResubmissionButton = $('#askForFileResubmissionButton');
  askForFileResubmissionButton.on('click', /*#__PURE__*/_asyncToGenerator( /*#__PURE__*/_babel_runtime_regenerator__WEBPACK_IMPORTED_MODULE_0___default().mark(function _callee() {
    var res;
    return _babel_runtime_regenerator__WEBPACK_IMPORTED_MODULE_0___default().wrap(function _callee$(_context) {
      while (1) {
        switch (_context.prev = _context.next) {
          case 0:
            _context.next = 2;
            return fetch(askForFileResubmissionButton.data('url')).then(function (res) {
              return res.json();
            });
          ...
          case 2:
            ...
            if (res.success) {
              ...
              addToast('fail', 'Error', res === null || res === void 0 ? void 0 : res.error);
            }
  ...
  (0,_datatable__WEBPACK_IMPORTED_MODULE_1__["default"])();
  (0,_deliver__WEBPACK_IMPORTED_MODULE_2__["default"])();
}
Orders();

function viewTime(_ref2) {
  var days = _ref2.days,
      hours = _ref2.hours,
