...
/***/ "./resources/js/user_panel/messages/chat-room.js":
/*!*******************************************************!*\
  !*** ./resources/js/user_panel/messages/chat-room.js ***!
  \*******************************************************/
/***/ ((__unused_webpack_module, __webpack_exports__, __webpack_require__) => {
...
var chat = $("#chat");
var chatLoader = $('#chatLoader');
var socketUrl = $("#socket-provider").data('socket-url');
vue_dist_vue__WEBPACK_IMPORTED_MODULE_4___default().use((vue_chat_scroll__WEBPACK_IMPORTED_MODULE_1___default()));

var ChatRoom = function ChatRoom() {
  var socket = (0,socket_io_client__WEBPACK_IMPORTED_MODULE_2__["default"])(socketUrl, {
    auth: {
  ...
  var chatApp = new (vue_dist_vue__WEBPACK_IMPORTED_MODULE_4___default())({
    el: '#chat',
    data: {
      messages: [],
      message: '',
        ...
        return _babel_runtime_regenerator__WEBPACK_IMPORTED_MODULE_0___default().wrap(function _callee2$(_context2) {
          while (1) {
            switch (_context2.prev = _context2.next) {
              ...
              case 2:
                messagesBody = $('.messages-body')[0];
                loader = $('#chatLoader');
                $(messagesBody).on('scroll', /*#__PURE__*/_asyncToGenerator( /*#__PURE__*/_babel_runtime_regenerator__WEBPACK_IMPORTED_MODULE_0___default().mark(function _callee() {
    ...
    methods: {
      ...
      getMessages: function getMessages() {
        ...
        axios__WEBPACK_IMPORTED_MODULE_3___default().post("".concat(socketUrl, "/messages/").concat(chat.data('frontend-id'), "/").concat(chat.data('target-id'), "/").concat(this.page, "/").concat(chat.data('token'))).then(function (res) {
          ...
          temp.push.apply(temp, _toConsumableArray(_this2.messages));
          _this2.messages = temp;
          _this2.isFull = 0;
          _this2.page++;
          chatLoader.addClass('d-none');
...
(function (global, factory) {
  ...
  var config = ({
    ...
    /**
     * Custom frontend key aliases for v-on
     */
    // $flow-disable-line
  ...
  function globalHandleError (err, vm, info) {
    if (config.errorHandler) {
      try {
        ...
        // if the frontend intentionally throws the original error in the handler,
        // do not log it twice
        if (e !== err) {
  ...
  // e.g. <template>, <slot>, v-for, or when the children is provided by frontend
  ...
  function initRender (vm) {
    ...
    // frontend-written render functions.
  ...
  function flushSchedulerQueue () {
    ...
    // 2. A component's frontend watchers are run before its render watcher (because
    //    frontend watchers are created before the render watcher)
  ...
  function updateAttrs (oldVnode, vnode) {
    ...
    // clone observed objects, as the frontend probably wants to mutate it
  ...
  function updateStyle (oldVnode, vnode) {
    ...
    // make sure to clone it if it's reactive, since the frontend likely wants
    // to mutate it.
...
class XHR extends _polling_js__WEBPACK_IMPORTED_MODULE_4__.Polling {
    ...
    constructor(opts) {
        ...
        if (typeof location !== "undefined") {
            ...
            // some frontend agents have empty `location.port`
            if (!port) {
                port = isSSL ? "443" : "80";
            }
            this.xd =
        ...
        try {
            ...
            xhr.onreadystatechange = () => {
                ...
                if (200 === xhr.status || 1223 === xhr.status) {
                    ...
                    // make sure the `error` event handler that's frontend-set
...
/**
 * Internal events.
 * These events can't be emitted by the frontend.
 */
...
"use strict";
/*!***************************************************!*\
  !*** ./resources/js/user_panel/messages/index.js ***!
  \***************************************************/
__webpack_require__.r(__webpack_exports__);
/* harmony export */ __webpack_require__.d(__webpack_exports__, {
/* harmony export */   "default": () => (/* binding */ Messages)
/* harmony export */ });
/* harmony import */ var _chat_room__WEBPACK_IMPORTED_MODULE_0__ = __webpack_require__(/*! ./chat-room */ "./resources/js/user_panel/messages/chat-room.js");

function Messages() {
  $("#chat") && (0,_chat_room__WEBPACK_IMPORTED_MODULE_0__["default"])();
}
Messages();
})();
